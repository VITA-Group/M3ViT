...
class Block(nn.Module):
    ...
    def flops(self):
        ...
        # norm2
        flops += self.dim * H * W
        # for _ in range(len(self.mlps)):
        #     # mlp
        #     flops += 2 * H * W * self.dim * self.dim * self.mlp_ratio * self.num_mlp
        #     # norm2
        #     flops += self.dim * H * W
        return flops
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, model_name='vit_large_patch16_384', img_size=384, patch_size=16, in_chans=3, embed_dim=1024, depth=24,
        ...
        print(model_name, img_size, patch_size, \
            in_chans, embed_dim, depth,\
                num_heads, num_classes, mlp_ratio, qkv_bias, qk_scale, drop_rate, \
                    attn_drop_rate, drop_path_rate, 'hybrid_backbone',hybrid_backbone, norm_layer, norm_cfg, \
                        pos_embed_interp, random_init, align_corners,'kwargs',kwargs)
    ...
    def init_weights(self, pretrained=None):
        ...
        if not self.random_init:
            ...
            if self.model_name in ['vit_tiny_patch16_224','vit_small_patch16_224', 'vit_base_patch16_224']:
    ...
    def _conv_filter(self, state_dict, patch_size=16):
        ...
        for k, v in state_dict.items():
            if 'patch_embed.proj.weight' in k:
                print('init weights shape',v.shape,patch_size)
